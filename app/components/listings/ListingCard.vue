<template>
  ...
  >
    ...
    <div class="relative aspect-[4/3] bg-gray-50 overflow-hidden">
      ...
      <!-- Photos count -->
      <span v-if="listing.photos_count" class="absolute bottom-3 right-3 badge-glass flex items-center gap-1">
    ...
    <div class="p-4">
      ...
      <!-- Location -->
      <p class="text-sm text-gray-500 mt-1.5 truncate flex items-center gap-1">
      ...
      <div class="flex items-center gap-4 text-xs text-gray-500">
        ...
        <span v-if="listing.surface_m2" class="flex items-center gap-1.5">
          <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Agency -->
      <p v-if="listing.agent_or_agency" class="text-[11px] text-gray-400 mt-3 truncate">
